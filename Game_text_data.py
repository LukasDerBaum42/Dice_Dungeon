...
enemy_cls = {
    'Mimic':{
        'stats': {'min_move': 0, 'max_move': 0, 'max_hp': 160, 'max_mp': 20, 'atk': 20, 'sp_atk': 6, 'def_': 18, 'sp_def':18, 'xp': 12, 'gold': 10, 'crit_chance': 8, 'crit_bonus': 20},
        'Attacks': {'Brutal Smash':50, 'Axe Swing':30, 'War Cry':20, 'Earthquake':40, 'Bone Crush':60},
        'Items': {
            'sword':{'chance':20, 'rarety': {'common':40, 'uncommon':30,'rare':15,'epic':10,'legendary':5}, 'level':[-1,5]},
            'spear':{'chance':20, 'rarety': {'common':40, 'uncommon':30,'rare':15,'epic':10,'legendary':5}, 'level':[-1,5]},
            'chestplate':{'chance':20, 'rarety': {'common':40, 'uncommon':30,'rare':15,'epic':10,'legendary':5}, 'level':[-1,5]},
            'helmet':{'chance':15, 'rarety': {'common':40, 'uncommon':30,'rare':15,'epic':10,'legendary':5}, 'level':[-1,5]}
        }
    },
    'Zomby':{
...
traps = {
    ...
    'Hole': {
        'text': 'As you walked a hole opened in witch you’ve fallen',
        'damage_type': 2,
        'damage': 10
    },
    'Tripwire': {
...
dungeons_preset = {
    'Standerd' : {
        'layers':['layer 1','layer 2','layer 3','layer 4','layer 5','layer 6','layer 7','layer 8','layer 9','layer 10'],
        'size': [10,20]
    },
    'Large' : {
        'layers':['layer 1','layer 2','layer 3','layer 4','layer 5','layer 6','layer 7','layer 8','layer 9','layer 10'],
